...
Proof.
  ...
  unfold t_update.
  extensionality k.
  destruct (String.eqb_spec x k) as [H1 | H1].
  - reflexivity.
  - reflexivity.
Qed.
...
Theorem t_update_permute : forall (A : Type) (m : total_map A)
  ...
  (x2 !-> v2 ; x1 !-> v1 ; m).
Proof.
  intros A m v1 v2 x1 x2 eq1.
  apply String.eqb_neq in eq1.
  unfold t_update.
  extensionality k.
  destruct (String.eqb_spec x1 k) as [H1 | H1].
  - rewrite <- H1. rewrite eq1. reflexivity.
  - reflexivity.
Qed.
(** [] *)
